...
function sendMessage() {
  ...
  // Fake reply (IMPROVED TEXT)
  setTimeout(() => {
    clearInterval(typingAnim);
    bubble.innerHTML =
      "Hi 😊 Thanks for your message!<br><br>" +
      "I’m <b>Lyceum AI</b> — an educational chatbot built by <b>Ananthu</b>.<br>" +
      "I’m currently in my learning and development phase 🛠️<br><br>" +
      "📚 Smart exam-focused answers (PSC, UPSC, school & college)<br>" +
      "🚀 Full AI features coming soon<br><br>" +
...
window.onload = () => {
  addMsg(
    ...
    "👋 <b>Hi bro!</b><br>" +
    "I’m <b>Lyceum AI</b> — an educational chatbot built by <b>Ananthu</b>.<br>" +
    "I’m currently in my learning phase 🛠️<br><br>" +
    "Ask me about exams, studies, or concepts."
  );
